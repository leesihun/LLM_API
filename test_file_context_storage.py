...
"""
    ...
    if success:
        print("[OK] File context saved successfully!")
        ...
        print("[FAIL] Failed to save file context")
        return
    ...
    if loaded_context:
        print("[OK] File context loaded successfully!")
        ...
        print("[FAIL] Failed to load file context")
        return
    ...
    if python_coder_tool.has_saved_file_context(test_session_id):
        print("    [OK] Context found! Reusing existing analysis")
